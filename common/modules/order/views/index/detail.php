        ...
        [
            'columns' => [
                [
                    ...
                    'value' => \common\modules\customer\models\Customer::findOne(['id' => $order->customer_id])->getFullName(),
                    'valueColOptions' => ['style' => 'width:30%'],
                ],
                [
...
<?php
// Order Items
echo $this->render('detail/items.php', [
    'order' => $order,
]);
?>

<?php
echo $this->render('detail/payment.php', [
    'order' => $order,
]);
?>

<?php
echo $this->render('detail/shipping.php', [
    'order' => $order,
]);
?>
