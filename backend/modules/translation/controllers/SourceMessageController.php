...
/**
 * SourceMessageController implements the CRUD actions for SourceMessage models.
 */
class SourceMessageController extends Controller
{
    ...
    /**
     * Displays a single SourceMessage models.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new SourceMessage models.
    ...
    /**
     * Updates an existing SourceMessage models.
    ...
    /**
     * Deletes an existing SourceMessage models.
    ...
    /**
     * Finds the SourceMessage models based on its primary key value.
     * If the models is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return SourceMessage the loaded models
